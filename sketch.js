...
function preload() {
   ...
   backgroundImgHallWay = loadImage("sprites/hallway.jpg");
...
function setup(){
    ...
    backgroundHall = createSprite(width/2 +100, height/2 - 90, width*2, height);
    backgroundHall.addImage(backgroundImgHallWay);
    backgroundHall.scale = 3.3;
    ...
    randF = Math.round(random(2,3)); 
    randM = Math.round(random(10,11));
    score = 0;
    room = 0; 
}
...
function draw(){
  console.log(gameState);
    ...
    if(gameState === 16){
      ...
      fill ("white");
      text("Thank you for helping me change back into my original body", 350, height/2);
      text("Press the Button above to help someone else Boy", 400, height/2 + 50);
...
function spawnPotion() {
    ...
    if (frameCount % 40 === 0) {
      ...
      potion.velocityX = -(15 + 3*score/10);
...
default: break;
  ...
  case 50: gameState =7; score = 0;
      break;
  case 51: gameState =6; score = score +5;
      break;
  case 52: gameState =7; score = 0;
      break;
  default: break;
